...
def part_02(args: List[str], options: Dict[str, any]):
    ...
    defragged = defrag_expanded_disk_3(disk_map)
    print(defragged)

    expanded_list = []
    print("Expanding the disk map...")
    for d in defragged:
        expanded_list.extend(expand_files(d))
    print(expanded_list)

    print("Calculating the checksum...")
    # checksum = calculate_checksum_2(defragged)
    checksum = calculate_checksum_3(expanded_list)

    print("Checksum:", checksum)

    # 9879421137466 is too high
    # 6389911791746 - i took this answer from someone elses code
    # I should revisit to see what I did wrong? AoC is usually a pain like this
